...
public class Player : MonoBehaviour
{
    ...
    private int enemyLayer; // 적 레이어
    private int BoxesLayer;
    private int barrelLayer;
    private int layerMask;
    public bool isFire = false; //  
    public bool isBoxes = false;
    ...
    void Start()
    {
        ...
        layerMask = 1<< enemyLayer| 1 << BoxesLayer | 1 << barrelLayer;
        movespeed = GameManger.Ginstance.gameData.speed;
        // 컴퍼넌트 캐시 처리
